...
class Search {
    ...
    public static function getAllStudentForGrid() {
        return 'SELECT STUDENT_ID, STUDENT_FNAME, STUDENT_LNAME, STUDENT_FNUMBER, STUDENT_EDUCATION_FORM, SPECIALITY_NAME_LONG, COURSE_NAME, SA_STUDENT_ID, GROUP_CONCAT( SUBJECT_NAME
